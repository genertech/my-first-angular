...
@Component({
  selector: 'app-fault-precise-positioning',
  templateUrl: './fault-precise-positioning.component.html',
  styleUrls: ['./fault-precise-positioning.component.css'],
  animations: [
...
export class FaultPrecisePositioningComponent implements OnInit {

  labelText: string = '故障精准定位';
  ...
  constructor(private dataService: FaultPrecisePositioningDataService) {
